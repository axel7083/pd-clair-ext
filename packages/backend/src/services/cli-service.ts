...
export abstract class CliService<D extends BaseCliDependencies> implements Disposable, AsyncInit {
  protected cliTool?: CliTool;

  constructor(protected dependencies: D) {}

  // Abstracts to be provided by concrete tools
  protected abstract get toolId(): string;
  protected abstract get displayName(): string;
  protected abstract get markdownDescription(): string;
  protected abstract get repoName(): string;
  protected abstract get orgName(): string;
